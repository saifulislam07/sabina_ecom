...
<div class="container-fluid">
  ...
  <div class="container fixednavbar">
    <div class="row mntitle1">
      <div class="col-md-6 padding0"> <a href="<?php echo site_url("home"); ?>">Home</a> &nbsp;>&nbsp; <a href="<?php echo site_url("home/category/" . $catNameList->catid); ?>"><?php echo $catNameList->catname; ?></a> &nbsp;>&nbsp; <?php echo $subcatNameList->subcatname; ?> </div>
...
<script>
     var s3 = $("#ranged-value").freshslider({
        ...
        onchange:function(low, high){
			...
			$.ajax({
				url: '<?php echo base_url('home/subcatpricerange/'.$subcatNameList->subcatid); ?>?low='+low+'&high='+high,
				type: 'GET',
				dataType: 'html',

...
<div class="container-fluid">
  ...
  <div class="container fixednavbar">
    <div class="row mntitle1">
      <div class="col-md-6 padding0"> <a href="<?php echo site_url("home"); ?>">Home</a> &nbsp;>&nbsp; <a href="<?php echo site_url("home/category/" . $catNameList->catid); ?>"><?php echo $catNameList->catname; ?></a> &nbsp;>&nbsp; <a href="<?php echo site_url("home/subCategory/" . $subcatNameList->subcatid); ?>"><?php echo $subcatNameList->subcatname; ?></a> &nbsp;>&nbsp; <?php echo str_replace('-', ' ', $subcatColorNameList->colorname); ?> </div>
      <div class="col-md-1 padding0"> Price Range </div>
	...
	<div class="row prview1">
		<div class="col-md-3">
			<div class="row ltsubcat1">
				...
				<div class="form-inline"><?php foreach($subcatsizeList as $v) { ?><div class="form-group ltsubcat3"><a href="<?php echo base_url("home/subCategorySizeSearch/" .$v->subcatid.'/'.$v->prosize); ?>" class="sizebun"><?php echo str_replace('-', ' ', $v->prosize); ?></a></div><?php } ?></div>
				...
				<?php foreach($subcatcolorList as $v) { ?>
				<div class="cls1"><a href="<?php echo site_url("home/subCategoryColorSearch/".$v->subcatid.'/'.$v->colorname); ?>"><span style="border:solid 1px #eeeeee; background-color:<?php echo $v->colorcode; ?>; padding:2px 10px;"></span> &nbsp; <?php echo str_replace('-', ' ', $v->colorname); ?></a></div>
				<?php } ?>
			</div>
		</div>
...
<script>
     var s3 = $("#ranged-value").freshslider({
        ...
        onchange:function(low, high){
			...
			$.ajax({
				url: '<?php echo base_url('home/subcatpricerangeColor/'.$subcatNameList->subcatid.'/'.$subcatColorNameList->colorname); ?>?low='+low+'&high='+high,
				type: 'GET',
				dataType: 'html',

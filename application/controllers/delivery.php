...
class Delivery extends CI_Controller {
    ...
    public function deliveryconfim() {
        ...
        $productdetails = $this->M_cloud->find('book_manage', array('bkId' => $productid));
        ...
        $data['product_id'] = $productdetails->bkId;
        $data['product_price'] = $productdetails->bkprice;
        ...
        redirect('delivery/paymentProcess/');
    }
    ...
    public function paymentprocessAction() {
        ...
        redirect('delivery/orderhistory');
    }
